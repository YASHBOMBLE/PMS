...
function Addsalesman() {
  ...
  useEffect(()=>{
    ...
    async function addmanagers() {
        const response = await axios.post('/addsalesman', {
            fname: fname,
            lname: lname,
            email: email,
            password: password,
  ...
  return (
    ...
    <center><h5>Add Saleman Page</h5></center>
    ...
    <div className="form-group">
                    ...
                    <button className="btn btn-primary" onClick={addmanagers}>Add Salesman</button>
</div></div>
  )
}
